...
import { RunCompetitionRepositoryMock } from "./RunCompetitionRespositoryMock"

export default class RunCompetitionDataMock extends BaseDatabase implements RunCompetitionRepositoryMock {
